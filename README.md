...
### Reading Group
Please let Wooil Lee (lwi2765 -at- khu -dot- ac -dot- kr) know what paper you are going to present, and **please** provide the conference name, year, and a brief summary by **Thursday 11:59 AM** before your presentation.

Moreover, send the **presentation slides link** by **Sunday 11:59 PM**.

This semester, we will have one presenter each week. The presentation duration is up to the presenter, as long as it does not exceed one hour.
...
#### What should I do if I cannot present at the scheduled time?
...
#### How does it work?
We are a group that meets about once a week to discuss relevant papers. For every meeting, one presenter will be in charge of selecting the paper(s) for that meeting, thoroughly understanding the work, and leading the discussion, either informally or via a presentation. The rest of the members will read over the paper(s) beforehand to gain a basic idea of the work. Then, on the day of the meeting, we will discuss the strengths, weaknesses, and techniques of the paper(s).

**NOTE:** Please tell the group organizer Wooil Lee (lwi2765 -at- khu -dot- ac -dot- kr) which paper(s) you are going to present, and summarize the paper/talk in several sentences before **Thursday** of that week.

#### What do we read?
We will be reading papers appearing in the leading computer vision conferences (e.g., CVPR, ICCV, ECCV, SIGGRAPH, SIGGRAPH Asia) and machine learning conferences (e.g., NeurIPS, ICML, ICLR), and other AI conferences (e.g., MICCAI, ACL, EMNLP, NAACL, UAI, AAAI, IJCAI, AISTATS). Members are free to choose which paper(s) they will present. We can also provide suggestions, so the specific topics will vary based on the members' interests.
